...
const COUNTRIES = [
  ...
  "Kazakhstan","Kenya","Kiribati","Koweït","Laos","Lesotho","Lettonie","Liban","Liberia","Libye",
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const dest = formData.role === "SELLER" ? "/seller/subscriptions" : "/account/subscriptions";
      router.push(dest);
    } catch {
        ...
        <div className="mx-auto max-w-2xl px-6 py-12">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            >
              ...
              />
              <h3 className="font-bold text-lg mb-1">Créateur</h3>
              <p className="text-xs text-slate-400">
          ...
          <form onSubmit={handleSubmit} className="glass rounded-3xl p-8">
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <Globe className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 pointer-events-none z-10" />
                <select
                  name="country"
                  value={formData.country}
                  onChange={(e) => setFormData((prev) => ({ ...prev, country: e.target.value }))}
                  required
                  className="w-full pl-12 pr-10 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:border-brand-gold/50"
                >
