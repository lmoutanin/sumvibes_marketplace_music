          ...
          {!isProfileCompleteForPurchase && (
            <div className="glass rounded-xl p-4 border border-brand-gold/30 text-brand-gold flex items-start justify-between gap-4 mb-6">
              ...
              <Link
                ...
                className="relative group px-5 py-2 rounded-none font-bold text-brand-purple overflow-hidden flex items-center gap-2 flex-shrink-0 transition-all hover:scale-105 text-sm whitespace-nowrap"
              >
              ...
              <form onSubmit={handlePayment} className="space-y-8">
                <div className="glass rounded-3xl p-8">
                  ...
                  <div className="flex items-center gap-3 glass rounded-xl p-4">
                    <CreditCard className="w-8 h-8 text-brand-gold/60" />
                    <div>
