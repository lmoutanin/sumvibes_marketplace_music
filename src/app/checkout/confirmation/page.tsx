      ...
      <main className="pt-20">
        <section className="mx-auto max-w-3xl px-6 py-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/account/downloads" className="btn-primary rounded-none bg-gradient-to-r from-brand-gold to-brand-gold-dark px-8 py-4 font-bold text-black hover:scale-105 flex items-center gap-3">
              Mes téléchargements
              <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="/catalogue" className="glass rounded-none px-8 py-4 font-bold hover:bg-white/10 flex items-center gap-3">
