        ...
        <div className="mx-auto max-w-7xl">
              ...
              {SERVICE_CATEGORIES.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={`px-5 py-2.5 rounded-none text-sm font-bold transition-all shadow-md flex items-center gap-2 ${isActive
                      ? "bg-brand-gold text-black shadow-[0_0_15px_rgba(254,215,102,0.4)] scale-105"
          ...
          <div>
            <div className="flex items-center justify-between mb-8">
              ...
              <span className="text-sm font-medium text-slate-400 bg-white/5 px-4 py-1.5 rounded-none border border-white/10">
            ...
            {loading ? (
              ...
              <div className="glass rounded-3xl p-16 text-center border border-white/10 bg-black/20">
                ...
                <button
                  ...
                  className="btn-primary px-8 py-3 rounded-none font-bold shadow-lg"
                >
