      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 text-xs text-slate-400 flex-wrap">
            ...
            {cat && <span className="glass px-2 py-0.5 rounded">{cat.label}</span>}
        ...
        <div className="mx-auto max-w-5xl px-6 py-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            {user && (
              <button onClick={() => setShowModal(true)}
                className="btn-primary px-6 py-3 rounded-none font-semibold flex items-center gap-2">
          ...
          <div className="flex gap-2 flex-wrap mb-6">
            {CATEGORIES.map(c => (
              <button key={c.id} onClick={() => setActiveCategory(c.id)}
                className={`px-4 py-2 rounded-none text-sm font-semibold transition-all ${activeCategory === c.id ? "bg-brand-gold text-brand-purple" : "glass hover:bg-white/10"
                  }`}>
                {c.label}
              </button>
            ))}
          ...
          {loading ? (
            ...
            <div className="glass rounded-2xl p-8 text-center">
              ...
              <button onClick={fetchPosts} className="btn-primary px-6 py-2 rounded-none mt-4 text-sm">
                Réessayer
              </button>
            </div>
          ) : (
              ...
              {regular.length > 0 ? (
                ...
                <div className="glass rounded-2xl p-12 text-center">
                  ...
                  {user && !debouncedSearch && (
                    <button onClick={() => setShowModal(true)} className="btn-primary px-6 py-3 rounded-none mt-4">
          ...
          <div ref={modalRef}
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => setShowModal(false)}
                className="p-2 rounded-none hover:bg-white/10 transition-colors text-slate-400 hover:text-white">
                <X className="w-5 h-5" />
              </button>
            </div>
