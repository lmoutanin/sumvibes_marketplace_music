        ...
        <section className="px-6 py-12 md:py-16">
          <div className="mx-auto max-w-7xl">
            ...
            <p className="text-xl text-slate-400 max-w-2xl">
              Découvrez les compositeurs vérifiés qui font vivre SUMVIBES.
            </p>
          </div>
        </section>
              ...
              <div className="flex flex-wrap gap-2">
                {genres.map((g) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-none text-sm font-medium transition-all ${selectedGenre === g
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {producers.map((producer) => (
                  ...
                  >
                    ...
                    {/* Stats */}
                    <div className="pt-6 mt-auto border-t border-white/10 text-center">
                      ...
                      <div className="text-xs text-slate-500">Compositions</div>
                    </div>
                  </Link>
                ))}
              </div>
