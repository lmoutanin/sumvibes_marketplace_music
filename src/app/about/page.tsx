...
export default function AboutPage() {
  ...
  const timeline = [
    { year: "2024", event: "Naissance de l'idée SUMVIBES", description: "SAS BE GREAT imagine une marketplace qui respecte les artistes et les compositeurs." },
          ...
          <div className="glass relative overflow-hidden rounded-3xl p-12 md:p-20 text-center">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                <Link
                  href="/register"
                  className="btn-primary rounded-none bg-white px-10 py-5 font-bold text-black text-lg hover:scale-105 flex items-center gap-3"
                >
                ...
                <Link
                  href="/contact"
                  className="glass rounded-none px-10 py-5 font-bold text-lg hover:bg-white/10 flex items-center gap-3"
                >
                  Nous contacter
                </Link>
              </div>
