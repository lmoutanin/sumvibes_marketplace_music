    ...
    <div className="relative min-h-screen bg-gradient-premium"><Navbar />
      <main className="pt-20 flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <Link href="/login" className="btn-primary px-6 py-3 rounded-none">Se connecter</Link>
        </div>
      </main>
    </div>
  );
      ...
      <main className="pt-20">
        <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <span className="glass px-4 py-2 rounded-none text-sm">{purchases.length} achat{purchases.length !== 1 ? "s" : ""}</span>
          </div>
          ...
          {loading ? (
            ...
            <div className="glass rounded-2xl p-12 text-center">
              ...
              {purchases.length === 0
                ? <><p className="text-slate-400 mb-4">Aucun achat pour l'instant</p><Link href="/catalogue" className="btn-primary px-6 py-3 rounded-none">Découvrir les beats</Link></>
          ...
          <div className="glass rounded-3xl p-8 mt-12 border-t-4 border-t-brand-gold/50 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
              ...
              {/* Premium */}
              <div className="glass bg-brand-gold/5 border border-brand-gold/20 rounded-2xl p-6 relative overflow-hidden group hover:border-brand-gold/50 transition-colors hover:shadow-[0_0_30px_rgba(254,215,102,0.15)]">
