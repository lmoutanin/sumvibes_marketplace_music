          ...
          <div className="flex flex-wrap gap-2 mb-8">
            {tabs.map((tab) => (
              <button
                ...
                className={`px-5 py-2.5 rounded-none text-sm font-semibold flex items-center gap-2 transition-all ${activeTab === tab.id
            ...
            >
                  ...
                  <div className="glass rounded-2xl w-full max-w-2xl p-6 border border-white/10">
                    ...
                    <div className="flex gap-3 mt-4 justify-end">
                      ...
                      <button
                        ...
                        className="relative group px-5 py-2 rounded-none font-bold text-brand-purple overflow-hidden flex items-center gap-2 disabled:opacity-50 transition-all hover:scale-105 text-sm"
                      >
                ...
                <div className="mb-8 p-6 glass rounded-2xl border border-brand-gold/20">
                  ...
                  <div className="mt-4 flex justify-end">
                    <button
                      ...
                      className="relative group px-5 py-2 rounded-none font-bold text-brand-purple overflow-hidden flex items-center gap-2 flex-shrink-0 transition-all hover:scale-105 text-sm"
                    >
                      <div className="absolute inset-0 bg-brand-gold group-hover:bg-amber-400 transition-colors"></div>
                      <span className="relative z-10 flex items-center gap-2">
                      ...
                      <div className="flex flex-wrap gap-3">
                        {GENRES.map((genre) => (
                          <label key={genre} className="cursor-pointer">
                            ...
                            />
                            <span className="inline-block px-4 py-2 rounded-none text-sm bg-white/5 border border-white/10 text-slate-300 peer-checked:bg-brand-gold peer-checked:text-brand-purple peer-checked:border-brand-gold peer-checked:font-semibold hover:bg-white/10 transition-all">
              ...
              <div className="flex justify-end mt-10 pt-8 border-t border-white/5">
                <button
                  type="submit"
                  disabled={loading}
                  className="relative group px-10 py-3 rounded-none font-bold text-brand-purple overflow-hidden flex items-center gap-3 disabled:opacity-50 transition-all hover:scale-105"
                >
                  <div className="absolute inset-0 bg-brand-gold group-hover:bg-amber-400 transition-colors"></div>
              ...
              <div className="glass rounded-3xl p-8 border border-red-500/10 relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pl-4">
                  ...
                  <button
                    ...
                    type="button"
                    className="shrink-0 px-8 py-4 rounded-none font-bold text-red-500 bg-red-500/10 border border-red-500/20 hover:bg-red-500 hover:text-white hover:border-red-500 transition-all shadow-[0_0_20px_rgba(239,68,68,0.1)] hover:shadow-[0_0_30px_rgba(239,68,68,0.3)] hover:scale-105"
                  >
                    Supprimer le compte
                  </button>
                </div>
