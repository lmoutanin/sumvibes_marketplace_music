      ...
      <div className="min-h-screen bg-gradient-premium">
        ...
        <main className="pt-28 pb-16 px-4">
          <div className="mx-auto max-w-xl glass rounded-3xl border border-red-500/30 p-8 text-center">
            ...
            <Link href="/account" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-none bg-brand-gold text-brand-purple font-bold hover:scale-105 transition-transform">
              Retour au compte
            </Link>
          </div>
        </main>
          ...
          <div className="mx-auto max-w-2xl glass rounded-3xl border border-brand-gold/30 p-8">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-none bg-brand-gold text-brand-purple font-bold hover:scale-105 transition-transform"
              >
                Compléter mon profil
              </Link>
              <Link
                href="/seller/dashboard"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-none glass border border-white/15 text-white hover:bg-white/10"
              >
                Retour dashboard
              </Link>
            </div>
      ...
      case 4:
        return (
          <div className="space-y-3">
            ...
            ).map(({ name, label, sublabel, border, ring, badge, disabled, lockMsg }) => (
              <div
                key={name}
    ...
    <div className="min-h-screen bg-gradient-premium">
      ...
      <main className="pt-20 pb-16">
        <div className="mx-auto max-w-[560px] px-4">
          ...
          <div className="mb-8">
            <div className="relative h-1.5 bg-white/8 rounded-none mb-6 overflow-hidden">
              <div
                className="absolute inset-y-0 left-0 rounded-none transition-all duration-500 ease-out bg-gradient-to-r from-brand-gold to-yellow-400"
