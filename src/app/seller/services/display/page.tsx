...
function EditServiceModal({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex">
            ...
            {/* Drawer */}
            <div className="relative ml-auto w-full max-w-xl h-full bg-[#020c1b] border-l border-white/10 flex flex-col shadow-[-20px_0_60px_rgba(0,0,0,0.8)]">
                {/* Header */}
                        ...
                        {loading ? (
                            ...
                            <div className="text-center py-20 px-4">
                                ...
                                <Link
                                    ...
                                    className="group relative inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-brand-gold via-yellow-400 to-brand-gold bg-[length:200%_auto] hover:bg-[position:right_center] rounded-none font-extrabold text-black overflow-hidden shadow-[0_4px_20px_rgba(254,215,102,0.3)] hover:shadow-[0_8px_30px_rgba(254,215,102,0.5)] hover:-translate-y-1 transition-all duration-500"
                                >
                                    <div className="absolute inset-0 bg-white/30 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out rounded-none" />
