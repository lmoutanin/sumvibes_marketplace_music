        ...
        <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          <div className="glass rounded-3xl p-8 mb-8">
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <Link href="/account/settings" className="glass px-6 py-3 rounded-none font-semibold hover:bg-white/10 flex items-center gap-2">
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
                ...
                <div className="flex gap-3">
                  <Link
                    ...
                    className="px-5 py-2.5 rounded-none bg-brand-gold text-brand-purple font-bold hover:scale-105 transition-transform"
                  >
                    Compléter mon profil
                  </Link>
                  <Link
                    href="/seller/beats"
                    className="px-5 py-2.5 rounded-none glass border border-white/15 font-semibold hover:bg-white/10"
                  >
                    Aller à l'upload
                  </Link>
                </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <button onClick={fetchStats} className="btn-primary px-6 py-3 rounded-none mt-4">Réessayer</button>
            </div>
          )}
        </div>
      </main>
