    ...
    <div className="relative min-h-screen bg-gradient-premium">
      ...
      <main className="pt-20">
        <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          {/* Withdrawal Form */}
          {!showForm ? (
            <button onClick={() => setShowForm(true)} className="btn-primary px-8 py-3 rounded-none font-semibold flex items-center gap-2 mb-8">
            ...
            <div className="glass rounded-3xl p-8 mb-8">
              ...
              <div className="flex gap-3 mt-6">
                <button className="btn-primary px-8 py-3 rounded-none font-semibold flex items-center gap-2">
                  <Banknote className="w-5 h-5" /> Confirmer le retrait
                </button>
                <button onClick={() => setShowForm(false)} className="glass px-6 py-3 rounded-none font-semibold hover:bg-white/10">
                  Annuler
                </button>
              </div>
            </div>
