        ...
        <section className="mx-auto max-w-6xl px-6 py-12">
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <Link
                href="/catalogue"
                className="btn-primary inline-flex items-center gap-3 rounded-none bg-gradient-to-r from-brand-purple to-brand-pink px-10 py-5 font-bold text-white text-lg hover:scale-105"
              >
                <Music className="w-5 h-5" />
