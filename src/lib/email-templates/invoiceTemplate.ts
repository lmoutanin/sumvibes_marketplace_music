...
const B = {
  gold:         "#fed766",
  goldDark:     "#d4a920",
  goldFaint:    "rgba(254, 215, 102, 0.08)",
  goldBorder:   "rgba(254, 215, 102, 0.18)",
  goldBorder2:  "rgba(254, 215, 102, 0.35)",
  dark:         "#021145",
  darkMid:      "#120058",
  darkCard:     "#16006a",
  darkCardHi:   "#1c007e",
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom:1px solid ${B.goldBorder};">
        <tr>
          ...
          <td width="33%" style="padding:22px 28px;">
            ...
            <div>
              <span style="background:rgba(254,215,102,0.12);border:1px solid ${B.goldBorder2};color:${B.gold};font-size:11px;font-weight:800;padding:3px 10px;border-radius:20px;letter-spacing:0.5px;">✓ PAYÉ</span>
            </div>
          </td>
        </tr>
      </table>
