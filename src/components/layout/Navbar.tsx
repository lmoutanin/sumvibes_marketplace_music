        ...
        <nav className="fixed top-0 z-50 w-full glass border-b border-white/5">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                <Link href="/" className="flex items-center gap-3 group">
                    ...
                    />
                    <span className="text-xl font-bold tracking-tighter text-gradient font-display">
                        SUMVIBES
                    </span>
                </Link>
                ...
                <div className="hidden items-center gap-10 md:flex">
                    <Link href="/catalogue" className="text-sm font-medium hover:text-brand-gold transition-colors">
                        Catalogue
                    </Link>
                    <Link href="/producers" className="text-sm font-medium hover:text-brand-gold transition-colors">
                        Producteurs
                    </Link>
                    <Link href="/community" className="text-sm font-medium hover:text-brand-gold transition-colors">
                        Communauté
                    </Link>
                </div>
                        ...
                        <>
                            ...
                            {user ? (
                                            ...
                                            <div className="p-4 border-b border-white/10">
                                                <p className="font-semibold text-sm">{user.displayName || user.username}
                                                    <span className="ml-2 inline-block mt-2 px-2 py-1 bg-brand-gold/10 text-brand-gold text-xs rounded-full">
                                                        {user.role === "SELLER" ? "Créateur" : user.role === "ADMIN" ? "Admin" : "Artiste"}
                                                    </span>
                                                </p>
                                            </div>
                                            <div className="p-2">
                                ...
                                <>
                                    ...
                                    <Link
                                        href="/register"
                                        className="btn-primary rounded-none px-6 py-2.5 text-sm font-bold"
                                    >
                                        Rejoindre
                                    </Link>
                                </>
                ...
                <div className="md:hidden glass border-t border-white/10 animate-fade-in">
                    <div className="px-6 py-6 space-y-4">
                        ...
                        <div className="pt-4 border-t border-white/10 space-y-3">
                            ...
                            <Link
                                href="/register"
                                className="btn-primary block text-center rounded-none bg-brand-gold px-6 py-3 font-bold text-black"
                            >
                                Rejoindre
                            </Link>
                        </div>
