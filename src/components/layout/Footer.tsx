...
export function Footer() {
    return (
        <footer className="relative pt-24 pb-12 overflow-hidden border-t border-white/[0.06]">
            ...
            <div className="absolute top-0 left-0 w-[500px] h-[300px] bg-brand-gold/5 blur-[140px] rounded-full pointer-events-none" />
            ...
            <div className="mx-auto max-w-7xl px-6 relative z-10">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-3 group">
                                ...
                                <span className="text-slate-500 text-sm leading-relaxed">
                                    SAS BE GREAT<br />
                                    <span className="text-slate-600">Guadeloupe, France</span>
                                </span>
                            </div>
                            <div className="flex items-center gap-3">
                ...
                <div className="pt-8 border-t border-white/[0.06] flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="text-slate-600 text-xs">
                        ...
                        <span className="text-slate-400 font-bold">SUMVIBES</span>{" "}
                        by <span className="text-slate-500">SAS BE GREAT</span>. Tous droits réservés.
                    </div>
